...
function Refund() {
	return (
		<>
			<section className="refund-section ptb-80">
				<div className="container">
                    <div className="refund-area">
                        <div className="refund-wrapper">
                            <div className="refund-content">
                                <h3 className="title text-center">Refund Policy for {Logo_text}</h3>
                                <p>At {Logo_text}, we understand the importance of refund and are committed to protecting the personal information of our users. We believe in being transparent about our data collection and usage practices, and this Refund Policy outlines what information we collect, how we use it, and who we share it with.</p>
                            </div>
                            <div className="refund-content">
                            ...
                            <div className="refund-content">
                                ...
                                <p>If you have any questions or concerns regarding {Logo_text}'s Refund Policy or the information we collect, you can contact us at:</p>
                                <ul className="refund-list">
                                    <li>Email: <span>spport@{Logo_text}.com</span></li>
                                </ul>
                            </div>
                            <div className="refund-content">
                                <h4 className="title">Changes to Refund Policy:</h4>
                                <p>{Logo_text} reserves the right to modify this Refund Policy at any time. We will notify our users of any significant changes by posting a notice on our app or website and by updating the "Last Updated" date at the top of this policy. We encourage our users to regularly review this Refund Policy to stay informed about how we are protecting their personal information.</p>
                                <p>This Refund Policy was last updated on 2023-03-25.</p>
                            </div>
                        </div>
                    </div>
				</div>
